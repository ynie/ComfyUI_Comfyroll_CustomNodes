...
class CR_ControlNetStack:
    ...
    def controlnet_stacker(self, switch_1, controlnet_1, controlnet_strength_1, start_percent_1, end_percent_1,
        ...
        global CACHED_CONTROLNET_MAPPING
        # Initialise the list
        controlnet_list= []
        ...
        if controlnet_1 != "None" and  switch_1 == "On" and image_1 is not None:
            ...
            controlnet_1 = CACHED_CONTROLNET_MAPPING.get(controlnet_path)
            if controlnet_1 is None:
                controlnet_1 = comfy.controlnet.load_controlnet(controlnet_path)
                CACHED_CONTROLNET_MAPPING[controlnet_path] = controlnet_1
                print(f"[SLOW MODEL LOADING] Loading control net from {controlnet_path}")
        ...
        if controlnet_2 != "None" and  switch_2 == "On" and image_2 is not None:
            ...
            controlnet_2 = CACHED_CONTROLNET_MAPPING.get(controlnet_path)
            if controlnet_2 is None:
                controlnet_2 = comfy.controlnet.load_controlnet(controlnet_path)
                CACHED_CONTROLNET_MAPPING[controlnet_path] = controlnet_2
                print(f"[SLOW MODEL LOADING] Loading control net from {controlnet_path}")
        ...
        if controlnet_3 != "None" and  switch_3 == "On" and image_3 is not None:
            ...
            controlnet_3 = CACHED_CONTROLNET_MAPPING.get(controlnet_path)
            if controlnet_3 is None:
                controlnet_3 = comfy.controlnet.load_controlnet(controlnet_path)
                CACHED_CONTROLNET_MAPPING[controlnet_path] = controlnet_3
                print(f"[SLOW MODEL LOADING] Loading control net from {controlnet_path}")
